      ...
      <View style={styles.container}>
        ...
        <View style={[styles.emptyContainer, { paddingTop: insets.top }]}>
          <View style={styles.emptyIconBg}>
            <Ionicons name="cart" size={60} color="#fafafa" />
          </View>
          ...
          <TouchableOpacity onPress={() => navigation.getParent()?.navigate('Home')}>
            <LinearGradient colors={['#fafafa', '#fafafa']} style={styles.shopBtn} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom || 24 }]}>
        <LinearGradient colors={['rgba(9,9,11,0)', 'rgba(9,9,11,0.95)', '#09090b']} style={StyleSheet.absoluteFill} />
        <View style={{ paddingHorizontal: 20, paddingTop: 16 }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Checkout')}>
            <LinearGradient colors={['#fafafa', '#fafafa']} style={styles.checkoutBtn} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
...
const styles = StyleSheet.create({
  ...
  image: { width: 90, height: 90, borderRadius: 12, backgroundColor: '#0f0f1e' },
  info: { flex: 1, marginLeft: 12, justifyContent: 'space-between' },
  productTitle: { flex: 1, fontSize: 15, fontWeight: '600', color: '#e2e8f0', marginRight: 8, lineHeight: 20 },
  price: { fontSize: 16, fontWeight: '800', color: '#fafafa', marginTop: 4 },
  ...
  qtyText: { fontSize: 13, fontWeight: '700', color: '#f8fafc', minWidth: 20, textAlign: 'center' },
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0 },
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 },
  totalLabel: { fontSize: 14, fontWeight: '600', color: '#94a3b8' },
  totalValue: { fontSize: 24, fontWeight: '900', color: '#f8fafc' },
  checkoutBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
    borderRadius: 16, height: 56,
  },
  checkoutBtnText: { color: '#09090b', fontSize: 17, fontWeight: '800' },
  ...
  emptyTitle: { fontSize: 24, fontWeight: '800', color: '#f8fafc', marginBottom: 8 },
  ...
  shopBtnText: { color: '#09090b', fontSize: 16, fontWeight: '700' },
});
