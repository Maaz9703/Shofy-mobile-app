      ...
      {notifications.length === 0 && !loading ? (
        <View style={styles.emptyState}>
          <View style={styles.emptyIconBg}>
            <Ionicons name="notifications-off" size={50} color="#fafafa" />
          </View>
        ...
        <FlatList
          ...
          refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); fetchNotifications(); }} tintColor="#fafafa" colors={['#fafafa']} />}
...
const styles = StyleSheet.create({
  ...
  notificationMessage: { fontSize: 13, marginBottom: 4, color: '#94a3b8' },
  notificationDate: { fontSize: 11, color: '#475569' },
  unreadDot: { width: 8, height: 8, borderRadius: 4, marginLeft: 8, backgroundColor: '#fafafa' },
});
